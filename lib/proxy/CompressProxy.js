...
var ImgCompress = /** @class */ (function () {
    ...
    ImgCompress.prototype.compress = function (key, filePath, outputPath) {
        return __awaiter(this, void 0, void 0, function () {
            var img;
            return __generator(this, function (_a) {
                img = tinyImgFactory_1.TinyImgFactory.getTinyImg(key);
                // console.log('log:compress img', img)
                return [2 /*return*/, img === null || img === void 0 ? void 0 : img.handle(filePath, outputPath)];
            });
        });
    };
    return ImgCompress;
