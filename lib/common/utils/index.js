    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    patternFilePath = [
                        "".concat(node_path_1.default.join(process.cwd(), inputPath, '/**/*.*')).replace(/\\/g, '/'),
                    ];
...
function getFiles(dir, deep) {
    ...
    function findFiles(dir, deep) {
        if (node_fs_1.default.statSync(dir).isFile()) {
            ...
            if (deep === false)
                return;
            var files = node_fs_1.default.readdirSync(dir);
            files.forEach(function (file) {
                findFiles(node_path_1.default.join(dir, file), deep);
            });
        }
    }
...
function createFilterByExt(ext) {
    var exts = ext.split(',');
    return function (file) { return exts.includes(node_path_1.default.extname(file)); };
}
...
function mkdir(dir) {
    ...
    getDirname(dir)
        ...
        base = node_path_1.default.join(base, dir);
        if (!node_fs_1.default.existsSync(base))
            node_fs_1.default.mkdirSync(base);
    });
}
exports.mkdir = mkdir;
