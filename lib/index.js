...
var currentPkgFilePath = node_path_1.default.resolve((0, node_process_1.cwd)(), './package.json');
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a.localPkg = _c.sent();
                        _b = this;
                        return [4 /*yield*/, (0, package_json_1.default)('any-tiny')
            ...
            return __generator(this, function (_b) {
                try {
                    ...
                    if (localPkg.version && version && semver_1.default.lt(localPkg.version, version))
                        console.log(chalk_1.default.bgRed('please upgrade!'));
                }
                catch (error) { }
                return [2 /*return*/];
            });
